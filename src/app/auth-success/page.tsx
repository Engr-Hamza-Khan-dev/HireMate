 ...
 * /auth-success
 *
 * Landing page after a successful OAuth verification.
 * Reads provider / name / email / avatar from the URL query string,
 * shows a branded success screen, then auto-redirects to /dashboard.
 */
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="flex flex-1 flex-col">
        {/* Top bar — no nav needed on success screen */}
